...
export default function Playlist() {
  const [results, setResults] = useState({ name: null, songs: [] });
  ...
  const getPlaylist = async () => {
    axios
      .get("/api/playlist/get-playlist", { params: { _id: id } })
      .then((res) => {
        setResults({
          ...
          <div className="rounded-lg px-4 py-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <RiPlayListFill className="w-6 h-6 fill-gray-200" />
              ...
              <div
                ...
                onClick={() => {
                  ...
                  setCurrentSong(results.songs[0]?.url);
                }}
              >
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-col space-y-2 mt-6 relative z-20">
                ...
                {results.songs?.length === 0 && !loading && (
